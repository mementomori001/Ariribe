...
const CIRCLES = [
  ...
  },
  {
    ...
    bestFor:['aiko'], tags:['weapon','dmg_reduce'],
  ...
  },
  {
    ...
    bestFor:['nointo','shizuku'], tags:['splash'],
  ...
  },
  {
    ...
    bestFor:[], tags:['shield_stack','tank'],
  ...
  },
  {
    ...
    bestFor:[], tags:['dot_resist','fixed_dmg','cc'],
  ...
  },
  {
    ...
    bestFor:['vand'], tags:['crit_buff','mp_regen'],
  ...
  },
  {
    ...
    bestFor:['yue_plus'], tags:['dot_stack','revive'],
  ...
  },
  {
    ...
    bestFor:[], tags:['counter_all','dmg_buff'],
  ...
  },
  {
    ...
    bestFor:['oscar','nointo_plus'], tags:['atk_stack','revive'],
  ...
  },
  {
    ...
    bestFor:[], tags:['elemental_buff','lethal_null'],
  ...
  },
  {
    ...
    bestFor:['yue_plus','tio_plus'], tags:['dot_stack','revive','burn_convert'],
  ...
  },
  {
    ...
    bestFor:['aiko'], tags:['revive_ally','lethal_null_self'],
  ...
  },
  {
    ...
    bestFor:[], tags:['global_dmg_buff','skill_chain_on_hit'],
  ...
  },
  {
    ...
    bestFor:[], tags:['skill_chain_on_guard','cc','tank'],
  ...
  },
  {
    ...
    bestFor:[], tags:['guard_buff','mp_regen','revive'],
  ...
  },
  {
    ...
    bestFor:[], tags:['cc','self_atk_buff','heal'],
  ...
  },
  {
    ...
    bestFor:[], tags:['heal_on_hit','lethal_null'],
  ...
  },
  {
    ...
    bestFor:[], tags:['shield','dot_up','stealth'],
...
{ id:'vand', name:'ヴァンドゥル', rarity:'ur', type:'勇猛',
  ...
  pveScore:10,
  pveNote:'★27覚醒後、畑山愛子（UR）生存中は致死ダメでもHP1で生き残る（不死）。出血+凍結/目眩付与。味方が目眩を付与するたびに自身ATK+14%蓄積。前列不死身運用がPVEの定番。魔眼魔法陣で気力管理をしながら会心ダメも積み上げる。',
...
const SYNERGIES = [
  ...
  { id:'aiko_vand', label:'畑山愛子＆ヴァンドゥル（不死の前列・★27必須）', check:p=>p.some(c=>c.id==='aiko')&&p.some(c=>c.id==='vand'), desc:'ヴァンドゥル★27覚醒後、畑山愛子生存中は致死ダメでもHP1残存（不死）。8000階層以降のPVEで最も安定する前列構成。終末魔法陣を愛子に装備で敵受けるダメ+50%が永続。' },
  ...
  { id:'nointo_oscar', label:'火力底上げコンビ', check:p=>p.some(c=>c.id==='oscar')&&p.some(c=>c.id==='nointo_plus'), desc:'ノイントのスキルを発動する度にオスカーのスキルダメージと貫通があがる。'},
];
...
const BOSSES = [
  { id:'guard', name:'守衛', icon:'🛡', tiers:['under9000','10000plus'], threats:['高い回復能力','攻撃力低下デバフ','時間制限','非常に高い威力のスキル（単体攻撃）'], tip:'守衛の通常攻撃・スキルは全て単体攻撃のためスロット1に耐久役を置けば全ての攻撃をそこに集中させられます。8000階層超えるとユエがワンパンされやすくなります。一部先頭以外も攻撃してくる個体は宮崎奈々で凍結させましょう。',
    parties:[
      { title:'ヴァンドゥル不死パーティ（★27以上）', members:['1: ヴァンドゥル★27+ / 魔眼魔法陣','2: リューティリス / 武装魔法陣','3: 畑山愛子（速度最遅）/ 終末魔法陣','4: ミレディ / 闘神魔法陣','5: オスカー / ハロウィン魔法陣'], note:'ヴァンドゥルが全攻撃を受ける。一部先頭以外を攻撃する個体は宮崎奈々で凍結させる。<br>ソーナも可' },
  ...
  { id:'dragon', name:'黒竜・ティオ', icon:'🐉', tiers:['under9000','10000plus'], threats:['灼熱の蓄積によるスリップダメージ','攻撃時に灼熱を付与してくる個体は凍結ハメが効かない'], tip:'灼熱を無効化するサルゼ（灼熱耐性デフォルト100%）をバッファーとして編成するのが有効。リロールや宝石で灼熱耐性100%をつけると安定します。出血を付与してくる黒竜も同パーティで対応可。',
    parties:[
      { title:'灼熱耐性100%パーティー', members:['1: ヴァンドゥル★27+ / 魔眼魔法陣','2: ソーナ（灼熱耐性100%必須）/ 武装魔法陣','3: 畑山愛子（灼熱耐性100%必須）/ 終末魔法陣','4: ミレディ / 闘神魔法陣','5: オスカー/ ハロウィン魔法陣'], note:'ソーナで全体スキル攻撃を防ぎ畑山愛子を守ります。' },
      { title:'灼熱耐性100%でない場合', members:['1: ヴァンドゥル★27+ / 魔眼魔法陣','2: ミュウ / 武装魔法陣','3: 畑山愛子 / 終末魔法陣','4: サルゼ（灼熱耐性デフォルト100%）/ 闘神魔法陣','5: オスカー / ハロウィン魔法陣'], note:'道中の攻撃をヴァンドゥルで防ぎミュウをボス戦まで温存。ミュウの氷像でユエを守ります。サルゼは灼熱耐性100%で優秀なバッファー。' },
    ] },
  { id:'alraune', name:'エセアルラウネ', icon:'🌿', tiers:['under9000','10000plus'], threats:['毒の蓄積によるスリップダメージ','ターン開始時に全体へ毒を付与する個体は凍結ハメが効かない'], tip:'毒を無効化し、ユエの毒を解除できる白崎香織が有効。毒耐性100%をつけると安定します。',
    parties:[
      { title:'毒耐性100%パーティー', members:['1: ヴァンドゥル★27+ / 魔眼魔法陣','2: ソーナ（毒耐性100%必須）/ 武装魔法陣','3: 畑山愛子（毒耐性100%必須）/ 終末魔法陣','4: 白崎香織（毒耐性デフォルト100%・ユエの毒除去）/ 闘神魔法陣','5: オスカー / ハロウィン魔法陣'], note:'白崎香織はデフォルトで毒耐性100%を持ちスキルでオスカーの毒を除去できます。' },
      { title:'毒耐性100%でない場合', members:['1: ヴァンドゥル★27+ / 魔眼魔法陣','2: ミュウ / 武装魔法陣','3: 畑山愛子 / 終末魔法陣','4: 白崎香織 / 闘神魔法陣','5: オスカー / ハロウィン魔法陣'], note:'ミュウの氷像でボス以外の攻撃からオスカーを守ります。白崎香織でオスカーの毒を解除します。' },
    ] },
  { id:'hydra', name:'ヒュドラ', icon:'🐍', tiers:['under9000','10000plus'], threats:['毒・灼熱の蓄積','一部個体は戦闘不能後に1度復活','高い凍結耐性または行動制限耐性を持つ個体がいる'], tip:'基本は宮崎奈々の凍結で行動を封じて攻略。凍結耐性が高い個体はカム（目眩75%）で対応します。',
    parties:[
      { title:'凍結耐性900%・ガード100%パターン', members:['1: ヴァンドゥル★27+ / 魔眼魔法陣','2: カム / 武装魔法陣','3: 畑山愛子 / 終末魔法陣','4: クゼ（目眩で行動制限）/ 闘神魔法陣','5: オスカー / ハロウィン魔法陣'], note:'ヴァンドゥルの固有アーティファクト「魔人のマフラー」で命中を上げてガードを減らすと有効。' },
      { title:'行動制限耐性50%パターン', members:['1: ヴァンドゥル★27+ / 魔眼魔法陣','2: カム / 武装魔法陣','3: 畑山愛子 / 終末魔法陣','4: 宮崎奈々 / 幻海魔法陣','5: オスカー / ハロウィン魔法陣'], note:'宮崎奈々・カムに行動制限率増加の宝石を装備させると安定します（★15以上）。' },
  ...
  { id:'general', name:'汎用・その他ボス', icon:'⚔', tiers:['under9000','10000plus'], threats:['カトレア・ノイント・サソリもどき・ミレディ等','継続ダメージを持たない黒竜・エセアルラウネも含む'], tip:'宮崎奈々・カムで行動を封じれば比較的簡単に突破できます。ノイントが出血を付与してくる場合は黒竜の対策パーティを参考にしてください。',
    parties:[
      { title:'汎用パーティ（ヴァンドゥル★27以上）', members:['1: ヴァンドゥル★27+ / 魔眼魔法陣','2: カム / 武装魔法陣','3: 畑山愛子 / 終末魔法陣','4: 宮崎奈々 / 幻海魔法陣','5: オスカー / ハロウィン魔法陣'], note:'カムと宮崎奈々の妨害でボスの行動を封じながらオスカーで攻撃。' },
    ] },
  { id:'late', name:'10000階層以降', icon:'🔥', tiers:['10000plus'], threats:['URユエでは火力が不十分','継続ダメージへの耐性管理が重要'], tip:'無課金の場合、オスカーをメインアタッカーとして採用。装備・アーティファクトをユエから引き継いでください。',
    parties:[
      { title:'10000階層以降・基本パーティ', members:['1: ヴァンドゥル★27+ / 魔眼魔法陣','2: カム / 武装魔法陣','3: 畑山愛子（速度最遅・氷槍突き魔獣）/ 美女魔法陣','4: 宮崎奈々 / 闘神魔法陣','5: オスカー / ハロウィン魔法陣'], note:'※畑山愛子を速度最遅に調整し氷槍突きスキルを持つ2凸以上の氷属性魔獣を装備。\n※武器：火力重視→オルカン+メツェライ、円月輪 / 行動制限重視→パイルバンカー+シュラゲーン' },
    ] },
];
